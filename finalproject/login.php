...
<head>
    ...
    <title>Login</title>
    <img src="http://jeodot.com/images/original/quizzes/538.jpg" alt="Villain Header" height="150" width="99.0%">
</head>
<body>
  <h2>Welcome to the Superhero and Villain Review Base.</h2>
    <?php
      if($username && $userid) {
      echo "You are logged in as <b>$dbuser</b>. <a href='member.php'>Click here\n</a>";
      }
        else {
