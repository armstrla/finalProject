...
<head>
    ...
    <img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQt2g2MwzqSdz8MGvMfTXSBlPzGpnSs1qMO1r7rnS9ObD2-39t8" alt="Side Kicks" height="150" width="99.0%">
</head>
<body>

<div id="topMessage"> <h2>Welcome to the Superhero and Villain Review Base.</h2>.<h3><font color='blue'>User names and email addresses must be unique.  Once registered, an activation email will be sent to you.</font></h3></div>
<?php echo "
                         ...
                         $numrows = mysqli_num_rows($query);                        
                             if($numrows == 0) {                        
                               ...
                               $stmt->close();              
                                     ...
                                     $numrows = mysqli_num_rows($query);                                    
                                     if ($numrows == 1){                                                                          
                                         $site = "http://web.engr.oregonstate.edu/~armstrla/FinalProject";
                                         $webmaster = "armstrla@oregonstate.edu";
